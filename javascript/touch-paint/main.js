...
try{
  ...
  var zr=function(){
    ...
    setconsole.innerHTML+='<br><span style="font-size=8px">起终点标记</span><select disabled id=statorendmarker><option value="1" selected>ON</option><option value="0">OFF</option></select>'
